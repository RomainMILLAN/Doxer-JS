import { SlashCommandBuilder, Colors, EmbedBuilder, ChannelType, PermissionsBitField } from "discord.js";
import { SlashCommand } from "../../../types";
import sentry from "../../manager/sentry";
import { errorBuilder, coloredEmbed } from "../../manager/embedBuilder";
        ...
        interaction.guild.channels.create({
            ...
            .then((channel) => {
                ...
                sentry(
                    interaction.client,
                    "VoiceClick/Room",
                    whiteCheckMark + `Création d'une nouvelle salle audio (\`${channel.name.toString()}\`)`,
                    interaction.user,
                    `/room`
                );
            })
